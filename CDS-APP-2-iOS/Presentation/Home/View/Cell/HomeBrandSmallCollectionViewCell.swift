//
//  HomeBrandSmallCollectionViewCell.swift
//  CDS-APP-2-iOS
//
...
final class HomeBrandSmallCollectionViewCell: UICollectionViewCell {
    ...
    private func setLayout() {
        productImageView.snp.makeConstraints {
            ...
            $0.height.equalTo(136.adjusted)
            $0.leading.top.equalToSuperview()
        }
        
        labelStackView.snp.makeConstraints {
            $0.top.equalTo(productImageView.snp.bottom).offset(7.adjusted)
            $0.leading.equalTo(productImageView)
        }
        
        heartButton.snp.makeConstraints {
            $0.height.width.equalTo(44.adjusted)
            $0.bottom.trailing.equalTo(productImageView)
        }
    }
